...
try:
    ...
    raise RuntimeError("You need to copy your local_settings_example.py to local_settings.py to start running the project")
...
SECRET_KEY = '9@m29j_3vxn*f8y#o@wypas456p+j2c@+gu#9fjf(=0y4fsuh5'
